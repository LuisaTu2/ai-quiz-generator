import { HTTP_PATH, type Quiz, type Topic } from "./constants";
...
const getQuizData = async ({language, level, topics, setIsLoading, setQuiz, setSlide, setError}: GetQuizDataProps) => {
    setIsLoading(true)
    setQuiz({questions: []})
